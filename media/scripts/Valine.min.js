	...
	, function(e, t, n) {
			...
			r.prototype.init = function(e) {
					...
					"undefined" == typeof document)
							return void console;
					"undefined" == typeof AV ? d.dynamicLoadSource("script", {
					...
					return d.dynamicLoadSource("script", {
			...
			r.prototype._init = function() {
					...
					try {
							...
							k) {
									var E = d.create("script", "src", "//api.ip.sb/jsonip?callback=getIP")
							...
							M !== AV._config.applicationId && T !== AV._config.applicationKey && AV.init({
									appId: M,
									appKey: T,
									serverURLs: z
							});
							...
							if (!(B = B instanceof HTMLElement ? B : P[P.length - 1] || null))
									return;
							e.el = B,
							...
							var j = (0 == e.config.meta.length ? b : e.config.meta).map(function(t) {
							...
							e.el.innerHTML = '<div class="vwrap"><div class="vedit"><textarea id="veditor" class="veditor vinput" placeholder="' + e.placeholder + '"></textarea><div class="vctrl d-none"><span class="vemoji-btn">' + e.locale.ctrl.emoji + '</span> | <span class="vpreview-btn">' + e.locale.ctrl.preview + '</span></div><div class="vemojis" style="display:none;"></div><div class="vinput vpreview" style="display:none;"></div></div><div class="vcontrol d-none"><div class="col col-80"><div class="vheader item' + j.length + '">' + j.join("") + '</div></div><div class="col col-20 text-right"><button type="button" title="Cmd|Ctrl+Enter" class="vsubmit vbtn">' + e.locale.ctrl.reply + '</button></div></div><div style="display:none;" class="vmark"></div></div><div class="vinfo" style="display:none;"><div class="vcount col"></div></div><div class="vlist"></div><div class="vempty" style="display:none;"></div><div class="vpage txt-center"></div><div class="info"><div class="power txt-right">Powered By <a href="https://valine.js.org" target="_blank">Valine</a><br>v' + o + "</div></div>";
							var I = d.find(e.el, ".vempty");
							e.nodata = {
									show: function(t) {
											return I.innerHTML = t || e.locale.tips.sofa,
											d.attr(I, "style", "display:block;"),
											e
									},
									hide: function() {
											return d.attr(I, "style", "display:none;"),
											e
									}
							};
							...
							e.loading = {
									show: function(t) {
											...
											return t ? Q.insertBefore(N, n[0]) : Q.appendChild(N),
											e.nodata.hide(),
											e
									},
									hide: function() {
											...
											return t && d.remove(t),
											0 === d.findAll(Q, ".vcard").length && e.nodata.show(),
											e
									}
							};
							...
							e.alert = {
									show: function(t) {
											V.innerHTML = '<div class="valert txt-center"><div class="vtext">' + (t && t.text || 1) + '</div><div class="vbtns"></div></div>';
											...
											d.on("click", d.find(V, ".vcancel"), function(t) {
													e.alert.hide()
											}),
									...
									hide: function() {
											return d.attr(V, "style", "display:none;"),
											e
									}
							},
							e.bind()
			...
			var k = function(e, t) {
				...
				, w = {
					add: function(e) {
							var t = d.findAll(document, ".leancloud_visitors,.leancloud-visitors");
							if (t.length) {
									var n = t[0]
										, r = d.attr(n, "id")
							...
							if (n.length) {
									...
									i.find().then(function(e) {
											e.length > 0 && d.each(e, function(e, t) {
													var n = t.get("url")
														, r = t.get("time")
														, i = d.findAll(document, '.leancloud_visitors[id="' + n + '"],.leancloud-visitors[id="' + n + '"]');
			...
			r.prototype.bind = function(e) {
					var t = this
						...
						, h = p.data;
					for (var v in h)
							h.hasOwnProperty(v) && function(e, t) {
									var r = d.create("i", {
											name: e,
											title: e
									});
					...
					var b = function(e) {
							...
							var n = d.findAll(t, "*")
								...
								, i = function(e, t) {
									var n = d.attr(e, t);
									n && d.attr(e, t, n.replace(/(javascript|eval)/gi, ""))
							};
							return d.each(n, function(e, t) {
									1 === t.nodeType && (r.indexOf(t.nodeName) > -1 && ("INPUT" === t.nodeName && "checkbox" === d.attr(t, "type") ? d.attr(t, "disabled", "disabled") : d.remove(t)),
					...
					for (var $ in A)
							A.hasOwnProperty($) && function() {
									var e = A[$]
										, n = d.find(t.el, "." + $);
									_[e] = n,
									n && d.on("input change blur", n, function(t) {
											"comment" === e ? k(n) : g[e] = d.escape(n.value.replace(/(^\s*)|(\s*$)/g, ""))
									})
							}();
					var E = function(e, t) {
						...
						, L = function(e) {
							var n = d.find(t.el, ".vh[rootid='" + e + "']")
								, r = d.find(n, ".vquote");
							return r || (r = d.create("div", "class", "vquote"),
							n.appendChild(r)),
							r
					}
						, M = function e() {
							...
							o.find().then(function(o) {
									...
									u.innerHTML = r * n < i ? '<button type="button" class="vmore vbtn">' + t.locale.ctrl.more + "</button>" : "";
									var p = d.find(u, ".vmore");
									p && d.on("click", p, function(t) {
											u.innerHTML = "",
											e(++n)
									}),
									t.loading.hide()
					...
					t.Q(y).count().then(function(e) {
							e > 0 ? (d.attr(d.find(t.el, ".vinfo"), "style", "display:block;"),
							d.find(t.el, ".vcount").innerHTML = '<span class="vnum">' + e + "</span> " + t.locale.tips.comments,
							M()) : t.loading.hide()
					}).catch(function(e) {
							t.ErrorHandler(e)
					});
					var T = function(e, n, r) {
							...
							for (var h = d.find(i, ".vat"), g = d.findAll(i, "a"), v = 0, x = g.length; v < x; v++) {
									var k = g[v];
									k && -1 == (d.attr(k, "class") || "").indexOf("at") && d.attr(k, {
											target: "_blank",
											rel: "nofollow"
									})
							}
						...
						, C = function() {
							setTimeout(function() {
									try {
											...
											"undefined" != typeof hljs && (d.each(d.findAll("pre code"), function(e, t) {
													hljs.highlightBlock(t)
											}),
											d.each(d.findAll("code.hljs"), function(e, t) {
					...
					!function() {
							...
							if (e) {
									...
									for (var r in n) {
											var i = n[r];
											d.find(t.el, ".v" + i).value = d.unescape(e[i]),
											g[i] = e[i]
									}
							}
					}();
					var P = function() {
						...
						, I = function(e) {
							return d.attr(j, "disabled") ? void t.alert.show({
									type: 0,
									text: t.locale.tips.busy + 'ヾ(๑╹◡╹)ﾉ"',
									ctxt: t.locale.ctrl.ok
							}) : "" == g.comment ? void _.comment.focus() : (g.nick = g.nick || "围观群众",
						...
						, Q = function() {
							...
							if (g.url = decodeURI(r),
							g.insertedAt = new Date,
							R.rid) {
									var i = R.pid || R.rid;
									n.set("rid", R.rid),
									n.set("pid", i),
									g.comment = g.comment.replace("<p>", '<p><a class="at" href="#' + i + '">' + R.at + "</a> , ")
							}
							for (var o in g)
							...
							n.setACL(N()),
							n.save().then(function(e) {
									"围观群众" != g.nick && x && x.setItem("ValineCache", JSON.stringify({
											nick: g.nick,
											link: g.link,
											mail: g.mail
									}));
									...
									try {
											if (R.rid) {
													var i = d.find(t.el, '.vquote[rid="' + R.rid + '"]') || L(R.rid);
													T(e, i, !0)
											} else
													n ? (r = Number(n.innerText) + 1,
													n.innerText = r) : d.find(t.el, ".vcount").innerHTML = '<span class="num">1</span> ' + t.locale.tips.comments,
													T(e, d.find(t.el, ".vlist"));
											g.mail && F({
													username: g.nick,
													mail: g.mail
											}),
											R.at && R.rmail && t.notify && W({
	...
	, function(e, t, n) {
			...
			!function(i) {
					...
					function p(e, t) {
							e[t >> 5] |= 128 << t % 32,
							e[14 + (t + 64 >>> 9 << 4)] = t;
							var n, r, i, a, s, p = 1732584193, f = -271733879, h = -1732584194, g = 271733878;
			...
			(function(t) {
					!function(t) {
											...
											for (; c < i.length; c++)
													!function(e) {
															"code" !== e.type ? --o || u() : l(e.text, e.lang, function(t, n) {
																	return t ? u(t) : null == n || n === e.text ? --o || u() : (e.text = n,
																	e.escaped = !0,
																	void (--o || u()))
															})
													}(i[c])
									...
									for (var n, r, i, o, a, s, l, c, u, d, p, h, v; e; )
											...
											s.header.length === s.align.length)) {
													...
													c = 0; c < d; c++)
															...
															this.options.smartLists && c !== d - 1 && (a = g.bullet.exec(i[c + 1])[0],
							...
							i.prototype.link = function(e, t, n) {
									...
									this.options.baseUrl && !b.test(e) && (e = u(this.options.baseUrl, e));
									try {
